...
export type SettingsTab = 'basic' | 'providers' | 'usage' | 'permissions' | 'mcp' | 'agents' | 'skills' | 'enhancePrompt' | 'community';
...
const sidebarItems: SidebarItem[] = [
  ...
  { key: 'enhancePrompt', icon: 'codicon-sparkle', labelKey: 'settings.enhancePrompt.title' },
